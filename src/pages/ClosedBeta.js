    ...
    <div className="ClosedBeta" ref={closedbetaRef}>
      ...
      <div className="introduction">
        ...
        <div className="introduction_textbox">
          ...
          통해서만 할 수 있나요? <br />1:1 만남의 데이팅앱이 부담스러웠다면 2:2, 3:3
          미팅은 어떠세요?<br /> 새로운 친구를 만들고 싶은 누구나 Memint에서 미팅에
          참여할 수 있어요! <br /><br />지금 베타 테스터를 신청하고 누구보다 빨리 토큰
          기반의 미팅앱 Memint를 체험해보세요!
        </div>
      </div>
      <img
